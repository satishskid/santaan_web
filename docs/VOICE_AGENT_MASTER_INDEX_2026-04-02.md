# Santaan Voice Agent Master Index

Date: April 2, 2026 (IST)
Purpose: Single entry point for all Santaan voice-agent operating documents

## Strategy Layer

- [VOICE_AGENT_PRODUCT_PHILOSOPHY_2026-04-02.md](/Users/spr/santaan%20hope/santaan-web/docs/VOICE_AGENT_PRODUCT_PHILOSOPHY_2026-04-02.md)
...
- [BOLNA_VOICE_AGENT_MAIN_SCRIPT_2026-04-02.md](/Users/spr/santaan%20hope/santaan-web/docs/BOLNA_VOICE_AGENT_MAIN_SCRIPT_2026-04-02.md)
- [BOLNA_VOICE_AGENT_TV_SCRIPT_2026-04-02.md](/Users/spr/santaan%20hope/santaan-web/docs/BOLNA_VOICE_AGENT_TV_SCRIPT_2026-04-02.md)
...
- [VOICE_AGENT_REVIEWER_SHEET_TEMPLATE_2026-04-02.csv](/Users/spr/santaan%20hope/santaan-web/docs/VOICE_AGENT_REVIEWER_SHEET_TEMPLATE_2026-04-02.csv)
- [VOICE_AGENT_REVIEWER_SHEET_GUIDE_2026-04-02.md](/Users/spr/santaan%20hope/santaan-web/docs/VOICE_AGENT_REVIEWER_SHEET_GUIDE_2026-04-02.md)

## Change Control

- [VOICE_AGENT_CHANGE_LOG_TEMPLATE_2026-04-02.md](/Users/spr/santaan%20hope/santaan-web/docs/VOICE_AGENT_CHANGE_LOG_TEMPLATE_2026-04-02.md)
...
1. configure `main` and `tv` Bolna agents from the final prompt blocks
2. configure extraction fields from the schema
3. configure webhook using the configuration map
4. test against the scenario pack
5. review with the QA scorecard
6. log prompt changes through the change log template
