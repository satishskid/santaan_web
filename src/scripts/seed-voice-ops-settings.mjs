...
const VOICE_OPS_BASELINE = {
  ...
  VOICE_AGENT_ROLLOUT_STATUS: "config_pending",
  VOICE_AGENT_MAIN_PROMPT_VERSION: "main-v1",
  VOICE_AGENT_TV_PROMPT_VERSION: "tv-v1",
  VOICE_AGENT_OPEN_RISKS:
    "VoBiz numbers still need linking inside Bolna. Exact Bhash post-call template identifier still pending from support.",
  VOICE_AGENT_CHANGE_NOTES:
    "Initial DID assignment selected on 2026-04-02: main=+918065481598, tv=+918065481542, backup=+918065481541.",
